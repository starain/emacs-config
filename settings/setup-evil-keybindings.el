      ...
      '(("f" (("a" helm-find-files)
        ...
        ("s" (("b" helm-occur)
              ...
              ("d" (("c" yi/w3m-dict-cn))
               "Dictonary"))
         "Search")
        ("h" (("a" (("h" hs-hide-all "Hide All (zm)")
                    ("s" hs-show-all "Show All (zr)"))
               "All")
              ("s" hs-show-block "Show Block (zo)")
              ("h" hs-hide-block "Hide Block (zc)")
              ("t" hs-toggle-hiding "Toggle (za)"))
         "Hide/Show")
